...
tape( 'the method accepts a radix parameter for serializing an instance as a string in bases 2 through 36', opts, function test( t ) {
	var values;
	var radix;
	var i;
	var x;
	...
	values = [
		...
		MAX_SAFE_INTEGER,
		MAX_SAFE_INTEGER + 1,
		TWO_63 - 1024 // Largest integer value less than 2^63 exactly representable as a double
	];
	...
	values.push( TWO_63 ); // when negated, corresponds to -(2^63)
