...
var bigint2words = require( '@stdlib/number-uint64-base-bigint2words' ).assign;
var number2words = require( '@stdlib/number-int64-base-number2words' ).assign;
...
var STRIDE = indices.LOW - indices.HIGH;
var OFFSET = indices.HIGH;
...
function Int64( value ) {
	...
	if ( isBigInt( value ) && BigInt.asIntN( 64, value ) === value ) {
		bigint2words( value, buffer, STRIDE, OFFSET );
	} else if ( isInteger( value ) && isBetween( value, -TWO_63, TWO_63, 'closed', 'open' ) ) {
		number2words( value, buffer, STRIDE, OFFSET );
	} else {
